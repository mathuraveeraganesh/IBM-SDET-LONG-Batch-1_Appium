...
AppiumDriver<MobileElement> driver;
	...
	public void VerifyCredentials(String UserName,String password,String Confirmation) throws InterruptedException {
		...
		try {
			...
			//Get into Login Form
			driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector().scrollable(true).instance(0)).scrollIntoView(textStartsWith(\"Target Practice\"))"));
